...
var file_npool_cloud_hashing_billing_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xb8, 0x01, 0x0a,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x44, 0x22, 0x56, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x42, 0x65, 0x6e, 0x65, 0x66, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x3a, 0x0a, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0xac, 0x1b, 0x20, 0x01,
	...
	0x57, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x42, 0x65, 0x6e,
	0x65, 0x66, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x04,
	0x49, 0x6e, 0x66, 0x6f, 0x18, 0x90, 0x1c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x2e, 0x68, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x62, 0x69, 0x6c, 0x6c,
	0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x42, 0x65, 0x6e, 0x65, 0x66,
	0x69, 0x74, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x51, 0x0a, 0x1f, 0x47, 0x65, 0x74, 0x55,
	...
	0x70, 0x70, 0x49, 0x44, 0x18, 0xf4, 0x1c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x41, 0x70, 0x70,
	0x49, 0x44, 0x12, 0x17, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x18, 0xf5, 0x1c, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x60, 0x0a, 0x20, 0x47,
	...
	0x3c, 0x0a, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x18, 0xd8, 0x1d, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x65, 0x6e, 0x65, 0x66, 0x69, 0x74, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xb5, 0x23,
...
var file_npool_cloud_hashing_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 55)
...
var file_npool_cloud_hashing_billing_proto_depIdxs = []int32{
	...
	55, // 37: cloud.hashing.billing.v1.CloudHashingBilling.Version:input_type -> google.protobuf.Empty
	2,  // 38: cloud.hashing.billing.v1.CloudHashingBilling.CreateCoinAccount:input_type -> cloud.hashing.billing.v1.CreateCoinAccountRequest
	4,  // 39: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccount:input_type -> cloud.hashing.billing.v1.GetCoinAccountRequest
	6,  // 40: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountsByAppUser:input_type -> cloud.hashing.billing.v1.GetCoinAccountsByAppUserRequest
	8,  // 41: cloud.hashing.billing.v1.CloudHashingBilling.DeleteCoinAccount:input_type -> cloud.hashing.billing.v1.DeleteCoinAccountRequest
	11, // 42: cloud.hashing.billing.v1.CloudHashingBilling.CreateCoinAccountTransaction:input_type -> cloud.hashing.billing.v1.CreateCoinAccountTransactionRequest
	13, // 43: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransaction:input_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionRequest
	18, // 44: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionsByCoinAccount:input_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionsByCoinAccountRequest
	20, // 45: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionsByCoin:input_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionsByCoinRequest
	22, // 46: cloud.hashing.billing.v1.CloudHashingBilling.UpdateCoinAccountTransaction:input_type -> cloud.hashing.billing.v1.UpdateCoinAccountTransactionRequest
	16, // 47: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionDetail:input_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionDetailRequest
	24, // 48: cloud.hashing.billing.v1.CloudHashingBilling.DeleteCoinAccountTransaction:input_type -> cloud.hashing.billing.v1.DeleteCoinAccountTransactionRequest
	27, // 49: cloud.hashing.billing.v1.CloudHashingBilling.CreatePlatformBenefit:input_type -> cloud.hashing.billing.v1.CreatePlatformBenefitRequest
	36, // 50: cloud.hashing.billing.v1.CloudHashingBilling.GetLatestPlatformBenefitByGood:input_type -> cloud.hashing.billing.v1.GetLatestPlatformBenefitByGoodRequest
	29, // 51: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefitsByGood:input_type -> cloud.hashing.billing.v1.GetPlatformBenefitsByGoodRequest
	34, // 52: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefit:input_type -> cloud.hashing.billing.v1.GetPlatformBenefitRequest
	32, // 53: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefitDetail:input_type -> cloud.hashing.billing.v1.GetPlatformBenefitDetailRequest
	39, // 54: cloud.hashing.billing.v1.CloudHashingBilling.CreatePlatformSetting:input_type -> cloud.hashing.billing.v1.CreatePlatformSettingRequest
	41, // 55: cloud.hashing.billing.v1.CloudHashingBilling.UpdatePlatformSetting:input_type -> cloud.hashing.billing.v1.UpdatePlatformSettingRequest
	43, // 56: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSettingByGood:input_type -> cloud.hashing.billing.v1.GetPlatformSettingByGoodRequest
	46, // 57: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSettingDetail:input_type -> cloud.hashing.billing.v1.GetPlatformSettingDetailRequest
	48, // 58: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSetting:input_type -> cloud.hashing.billing.v1.GetPlatformSettingRequest
	51, // 59: cloud.hashing.billing.v1.CloudHashingBilling.CreateUserBenefit:input_type -> cloud.hashing.billing.v1.CreateUserBenefitRequest
	53, // 60: cloud.hashing.billing.v1.CloudHashingBilling.GetUserBebefitsByAppUser:input_type -> cloud.hashing.billing.v1.GetUserBenefitsByAppUserRequest
	0,  // 61: cloud.hashing.billing.v1.CloudHashingBilling.Version:output_type -> cloud.hashing.billing.v1.VersionResponse
	3,  // 62: cloud.hashing.billing.v1.CloudHashingBilling.CreateCoinAccount:output_type -> cloud.hashing.billing.v1.CreateCoinAccountResponse
	5,  // 63: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccount:output_type -> cloud.hashing.billing.v1.GetCoinAccountResponse
	7,  // 64: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountsByAppUser:output_type -> cloud.hashing.billing.v1.GetCoinAccountsByAppUserResponse
	9,  // 65: cloud.hashing.billing.v1.CloudHashingBilling.DeleteCoinAccount:output_type -> cloud.hashing.billing.v1.DeleteCoinAccountResponse
	12, // 66: cloud.hashing.billing.v1.CloudHashingBilling.CreateCoinAccountTransaction:output_type -> cloud.hashing.billing.v1.CreateCoinAccountTransactionResponse
	14, // 67: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransaction:output_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionResponse
	19, // 68: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionsByCoinAccount:output_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionsByCoinAccountResponse
	21, // 69: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionsByCoin:output_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionsByCoinResponse
	23, // 70: cloud.hashing.billing.v1.CloudHashingBilling.UpdateCoinAccountTransaction:output_type -> cloud.hashing.billing.v1.UpdateCoinAccountTransactionResponse
	17, // 71: cloud.hashing.billing.v1.CloudHashingBilling.GetCoinAccountTransactionDetail:output_type -> cloud.hashing.billing.v1.GetCoinAccountTransactionDetailResponse
	25, // 72: cloud.hashing.billing.v1.CloudHashingBilling.DeleteCoinAccountTransaction:output_type -> cloud.hashing.billing.v1.DeleteCoinAccountTransactionResponse
	28, // 73: cloud.hashing.billing.v1.CloudHashingBilling.CreatePlatformBenefit:output_type -> cloud.hashing.billing.v1.CreatePlatformBenefitResponse
	37, // 74: cloud.hashing.billing.v1.CloudHashingBilling.GetLatestPlatformBenefitByGood:output_type -> cloud.hashing.billing.v1.GetLatestPlatformBenefitByGoodResponse
	30, // 75: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefitsByGood:output_type -> cloud.hashing.billing.v1.GetPlatformBenefitsByGoodResponse
	35, // 76: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefit:output_type -> cloud.hashing.billing.v1.GetPlatformBenefitResponse
	33, // 77: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformBenefitDetail:output_type -> cloud.hashing.billing.v1.GetPlatformBenefitDetailResponse
	40, // 78: cloud.hashing.billing.v1.CloudHashingBilling.CreatePlatformSetting:output_type -> cloud.hashing.billing.v1.CreatePlatformSettingResponse
	42, // 79: cloud.hashing.billing.v1.CloudHashingBilling.UpdatePlatformSetting:output_type -> cloud.hashing.billing.v1.UpdatePlatformSettingResponse
	44, // 80: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSettingByGood:output_type -> cloud.hashing.billing.v1.GetPlatformSettingByGoodResponse
	47, // 81: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSettingDetail:output_type -> cloud.hashing.billing.v1.GetPlatformSettingDetailResponse
	49, // 82: cloud.hashing.billing.v1.CloudHashingBilling.GetPlatformSetting:output_type -> cloud.hashing.billing.v1.GetPlatformSettingResponse
	52, // 83: cloud.hashing.billing.v1.CloudHashingBilling.CreateUserBenefit:output_type -> cloud.hashing.billing.v1.CreateUserBenefitResponse
	54, // 84: cloud.hashing.billing.v1.CloudHashingBilling.GetUserBebefitsByAppUser:output_type -> cloud.hashing.billing.v1.GetUserBenefitsByAppUserResponse
