...
const (
	...
	// FieldCreatedFor holds the string denoting the created_for field in the database.
	FieldCreatedFor = "created_for"
...
var (
	...
	// DefaultCreatedFor holds the default value on creation for the "created_for" field.
