...
const (
	// Label holds the string label denoting the goodsetting type in the database.
	Label = "good_setting"
	...
	// Table holds the table name of the goodsetting in the database.
	Table = "good_settings"
)

// Columns holds all SQL columns for goodsetting fields.
var Columns = []string{
	FieldID,
	FieldGoodID,
