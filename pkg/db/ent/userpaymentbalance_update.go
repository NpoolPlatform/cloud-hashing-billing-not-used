...
func (upbu *UserPaymentBalanceUpdate) SetCoinUsdCurrency(u uint64) *UserPaymentBalanceUpdate {
	upbu.mutation.ResetCoinUsdCurrency()
	upbu.mutation.SetCoinUsdCurrency(u)
	return upbu
}

// AddCoinUsdCurrency adds u to the "coin_usd_currency" field.
func (upbu *UserPaymentBalanceUpdate) AddCoinUsdCurrency(u int64) *UserPaymentBalanceUpdate {
	upbu.mutation.AddCoinUsdCurrency(u)
	return upbu
}

// SetCoinTypeID sets the "coin_type_id" field.
func (upbu *UserPaymentBalanceUpdate) SetCoinTypeID(u uuid.UUID) *UserPaymentBalanceUpdate {
	upbu.mutation.SetCoinTypeID(u)
	return upbu
}
...
func (upbu *UserPaymentBalanceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := upbu.mutation.CoinUsdCurrency(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
	...
	if value, ok := upbu.mutation.AddedCoinUsdCurrency(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: userpaymentbalance.FieldCoinUsdCurrency,
	...
	if value, ok := upbu.mutation.CoinTypeID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
...
// SetCoinUsdCurrency sets the "coin_usd_currency" field.
func (upbuo *UserPaymentBalanceUpdateOne) SetCoinUsdCurrency(u uint64) *UserPaymentBalanceUpdateOne {
	upbuo.mutation.ResetCoinUsdCurrency()
	upbuo.mutation.SetCoinUsdCurrency(u)
	return upbuo
}

// AddCoinUsdCurrency adds u to the "coin_usd_currency" field.
func (upbuo *UserPaymentBalanceUpdateOne) AddCoinUsdCurrency(u int64) *UserPaymentBalanceUpdateOne {
	upbuo.mutation.AddCoinUsdCurrency(u)
	return upbuo
}

// SetCoinTypeID sets the "coin_type_id" field.
func (upbuo *UserPaymentBalanceUpdateOne) SetCoinTypeID(u uuid.UUID) *UserPaymentBalanceUpdateOne {
	upbuo.mutation.SetCoinTypeID(u)
	return upbuo
}
...
func (upbuo *UserPaymentBalanceUpdateOne) Save(ctx context.Context) (*UserPaymentBalance, error) {
	...
	if len(upbuo.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, upbuo.mutation)
		if err != nil {
			return nil, err
		}
...
func (upbuo *UserPaymentBalanceUpdateOne) sqlSave(ctx context.Context) (_node *UserPaymentBalance, err error) {
	...
	if value, ok := upbuo.mutation.CoinUsdCurrency(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: userpaymentbalance.FieldCoinUsdCurrency,
	...
	if value, ok := upbuo.mutation.AddedCoinUsdCurrency(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: userpaymentbalance.FieldCoinUsdCurrency,
	...
	if value, ok := upbuo.mutation.CoinTypeID(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: userpaymentbalance.FieldCoinTypeID,
