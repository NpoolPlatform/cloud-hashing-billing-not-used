...
func init() {
	...
	goodpaymentDescCreateAt := goodpaymentFields[7].Descriptor()
	...
	goodpaymentDescUpdateAt := goodpaymentFields[8].Descriptor()
	...
	goodpaymentDescDeleteAt := goodpaymentFields[9].Descriptor()
