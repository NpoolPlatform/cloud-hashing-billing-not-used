...
func init() {
	...
	// coinaccounttransactionDescCreatedFor is the schema descriptor for created_for field.
	coinaccounttransactionDescCreatedFor := coinaccounttransactionFields[13].Descriptor()
	// coinaccounttransaction.DefaultCreatedFor holds the default value on creation for the created_for field.
	coinaccounttransaction.DefaultCreatedFor = coinaccounttransactionDescCreatedFor.Default.(string)
	// coinaccounttransactionDescCreateAt is the schema descriptor for create_at field.
	coinaccounttransactionDescCreateAt := coinaccounttransactionFields[14].Descriptor()
	...
	coinaccounttransactionDescUpdateAt := coinaccounttransactionFields[15].Descriptor()
	...
	coinaccounttransactionDescDeleteAt := coinaccounttransactionFields[16].Descriptor()
	...
	_ = goodpaymentFields
	// goodpaymentDescAvailableAt is the schema descriptor for available_at field.
	goodpaymentDescAvailableAt := goodpaymentFields[6].Descriptor()
	// goodpayment.DefaultAvailableAt holds the default value on creation for the available_at field.
	goodpayment.DefaultAvailableAt = goodpaymentDescAvailableAt.Default.(uint32)
	// goodpaymentDescCollectingTid is the schema descriptor for collecting_tid field.
	goodpaymentDescCollectingTid := goodpaymentFields[7].Descriptor()
	// goodpayment.DefaultCollectingTid holds the default value on creation for the collecting_tid field.
	goodpayment.DefaultCollectingTid = goodpaymentDescCollectingTid.Default.(func() uuid.UUID)
	// goodpaymentDescUsedFor is the schema descriptor for used_for field.
	goodpaymentDescUsedFor := goodpaymentFields[8].Descriptor()
	// goodpayment.DefaultUsedFor holds the default value on creation for the used_for field.
	goodpayment.DefaultUsedFor = goodpaymentDescUsedFor.Default.(string)
	// goodpaymentDescCreateAt is the schema descriptor for create_at field.
	goodpaymentDescCreateAt := goodpaymentFields[9].Descriptor()
	...
	goodpaymentDescUpdateAt := goodpaymentFields[10].Descriptor()
	...
	goodpaymentDescDeleteAt := goodpaymentFields[11].Descriptor()
	...
	userpaymentbalanceDescUpdateAt := userpaymentbalanceFields[9].Descriptor()
	...
	userpaymentbalanceDescDeleteAt := userpaymentbalanceFields[10].Descriptor()
	...
	userwithdrawDescCreateAt := userwithdrawFields[8].Descriptor()
	...
	userwithdrawDescUpdateAt := userwithdrawFields[9].Descriptor()
	...
	userwithdrawDescDeleteAt := userwithdrawFields[10].Descriptor()
