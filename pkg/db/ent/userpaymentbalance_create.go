...
func (upbc *UserPaymentBalanceCreate) SetCoinUsdCurrency(u uint64) *UserPaymentBalanceCreate {
	upbc.mutation.SetCoinUsdCurrency(u)
	return upbc
}

// SetCoinTypeID sets the "coin_type_id" field.
func (upbc *UserPaymentBalanceCreate) SetCoinTypeID(u uuid.UUID) *UserPaymentBalanceCreate {
	upbc.mutation.SetCoinTypeID(u)
	return upbc
}
...
func (upbc *UserPaymentBalanceCreate) Save(ctx context.Context) (*UserPaymentBalance, error) {
	...
	if len(upbc.hooks) == 0 {
		...
		v, err := mut.Mutate(ctx, upbc.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*UserPaymentBalance)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from UserPaymentBalanceMutation", v)
		}
		node = nv
	}
	return node, err
...
func (upbc *UserPaymentBalanceCreate) check() error {
	...
	if _, ok := upbc.mutation.CoinUsdCurrency(); !ok {
		return &ValidationError{Name: "coin_usd_currency", err: errors.New(`ent: missing required field "UserPaymentBalance.coin_usd_currency"`)}
	}
	if _, ok := upbc.mutation.CoinTypeID(); !ok {
...
func (upbc *UserPaymentBalanceCreate) createSpec() (*UserPaymentBalance, *sqlgraph.CreateSpec) {
	...
	if value, ok := upbc.mutation.CoinUsdCurrency(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: userpaymentbalance.FieldCoinUsdCurrency,
		})
		_node.CoinUsdCurrency = value
	}
	if value, ok := upbc.mutation.CoinTypeID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
...
// SetCoinUsdCurrency sets the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsert) SetCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsert {
	u.Set(userpaymentbalance.FieldCoinUsdCurrency, v)
	return u
}

// UpdateCoinUsdCurrency sets the "coin_usd_currency" field to the value that was provided on create.
func (u *UserPaymentBalanceUpsert) UpdateCoinUsdCurrency() *UserPaymentBalanceUpsert {
	u.SetExcluded(userpaymentbalance.FieldCoinUsdCurrency)
	return u
}

// AddCoinUsdCurrency adds v to the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsert) AddCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsert {
	u.Add(userpaymentbalance.FieldCoinUsdCurrency, v)
	return u
}

// SetCoinTypeID sets the "coin_type_id" field.
func (u *UserPaymentBalanceUpsert) SetCoinTypeID(v uuid.UUID) *UserPaymentBalanceUpsert {
	u.Set(userpaymentbalance.FieldCoinTypeID, v)
	return u
}
...
// SetCoinUsdCurrency sets the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsertOne) SetCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsertOne {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
...
// AddCoinUsdCurrency adds v to the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsertOne) AddCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsertOne {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
...
// UpdateCoinUsdCurrency sets the "coin_usd_currency" field to the value that was provided on create.
func (u *UserPaymentBalanceUpsertOne) UpdateCoinUsdCurrency() *UserPaymentBalanceUpsertOne {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
...
// SetCoinTypeID sets the "coin_type_id" field.
func (u *UserPaymentBalanceUpsertOne) SetCoinTypeID(v uuid.UUID) *UserPaymentBalanceUpsertOne {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
		s.SetCoinTypeID(v)
	})
}
...
// SetCoinUsdCurrency sets the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsertBulk) SetCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsertBulk {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
		s.SetCoinUsdCurrency(v)
	})
}
...
// AddCoinUsdCurrency adds v to the "coin_usd_currency" field.
func (u *UserPaymentBalanceUpsertBulk) AddCoinUsdCurrency(v uint64) *UserPaymentBalanceUpsertBulk {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
		s.AddCoinUsdCurrency(v)
	})
}
...
// UpdateCoinUsdCurrency sets the "coin_usd_currency" field to the value that was provided on create.
func (u *UserPaymentBalanceUpsertBulk) UpdateCoinUsdCurrency() *UserPaymentBalanceUpsertBulk {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
		s.UpdateCoinUsdCurrency()
	})
}
...
// SetCoinTypeID sets the "coin_type_id" field.
func (u *UserPaymentBalanceUpsertBulk) SetCoinTypeID(v uuid.UUID) *UserPaymentBalanceUpsertBulk {
	return u.Update(func(s *UserPaymentBalanceUpsert) {
		s.SetCoinTypeID(v)
	})
}
